...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-6n+$^sa+%qex3ye#35^1zjb11s$l(+^i9w7&-r84c28r_tk*7s')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,*.railway.app,nguyenminh993.up.railway.app').split(',')
...
# Azure Storage Settings (optional - only if you want to use Azure)
if not DEBUG and os.environ.get('AZURE_ACCOUNT_NAME'):
    ...
    AZURE_URL_EXPIRATION_SECS = 3600 # Optional: URL expiration for private blobs
